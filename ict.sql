...
--
-- Хост: localhost
-- Время создания: Окт 29 2018 г., 14:53
...
('root', '[{"db":"ict","table":"companies"},{"db":"ict","table":"vfeedbacks"},{"db":"ict","table":"vacancies"},{"db":"ict","table":"users"},{"db":"ict","table":"resumes"}]');
...
CREATE TABLE `users` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `isEmployee` varchar(255) NOT NULL,
...
--
-- Структура таблицы `vfeedbacks`
--

CREATE TABLE `vfeedbacks` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Индексы таблицы `vfeedbacks`
--
ALTER TABLE `vfeedbacks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`),
...
ALTER TABLE `vacancies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vfeedbacks`
--
ALTER TABLE `vfeedbacks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `companies`
  ADD CONSTRAINT `companies_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `users` (`id`);
...
--
-- Ограничения внешнего ключа таблицы `vfeedbacks`
--
ALTER TABLE `vfeedbacks`
  ADD CONSTRAINT `vfeedbacks_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `vfeedbacks_ibfk_2` FOREIGN KEY (`resume_id`) REFERENCES `resumes` (`id`);
